...
- **GitHub organization:** [opto-sync-test](https://github.com/opto-sync-test)
- **Canonical GitHub Project:** [opto-sync-test-project](https://github.com/orgs/opto-sync-test/projects/1) (project 1)
- **Canonical Linear project:** [planning workspace](https://linear.app/denman/project/githubcomopto-sync-test-ab3f68a9b25a)
- **Organization documentation repository:** [opto-sync-test/.github](https://github.com/opto-sync-test/.github)
